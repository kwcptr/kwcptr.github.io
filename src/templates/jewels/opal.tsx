  ...
  return (
    <div>
      <div className="section__items2">
        <Title
          label="Opal"
          image="https://assets.playnccdn.com/gamedata/powerbook/lin2/aden/icon/46/image_92046.png"
        />
        <table className="article-table">
          ...
          <tbody>
            <tr>
              <td>Lv. 1</td>
              <td>-</td>
              <td><span style={{ color: '#00FF00' }}>&lt;Base effect&gt;</span><br />Paralysis Resistance +3%<br />Shock Resistance +3%<br />Pull Resistance +3%<br />Fear Resistance +3%<br />Silence Resistance +3%</td>
            </tr>
            <tr>
              <td>Lv. 2</td>
              <td>65%</td>
              <td><span style={{ color: '#00FF00' }}>&lt;Base effect&gt;</span><br />Paralysis Resistance +5%<br />Shock Resistance +5%<br />Pull Resistance +5%<br />Fear Resistance +5%<br />Silence Resistance +5%</td>
            </tr>
            <tr>
              <td>Lv. 3</td>
              <td>40%</td>
              <td><span style={{ color: '#00FF00' }}>&lt;Base effect&gt;</span><br />Paralysis Resistance +8%<br />Shock Resistance +8%<br />Pull Resistance +8%<br />Fear Resistance +8%<br />Silence Resistance +8%</td>
            </tr>
            <tr>
              <td>Lv. 4</td>
              <td>35%</td>
              <td><span style={{ color: '#00FF00' }}>&lt;Base effect&gt;</span><br />Paralysis Resistance +12%<br />Shock Resistance +12%<br />Pull Resistance +12%<br />Fear Resistance +12%<br />Silence Resistance +12%<br /><br /><span style={{ color: '#00FF00' }}>&lt;Active skill&gt;</span><br /><span style={{ color: '#FF8000' }}>Opal - Special Property</span><br />Buff effect: Immune to debuffs/ anomalies.<br />Duration: 5 sec.</td>
            </tr>
            <tr>
              <td>Lv. 5</td>
              <td>30%</td>
